...
#connection
$ns duplex-link $client1 $server1 12mb 100-ms DropTail
$ns duplex-link $client2 $server1 12mb 100-ms DropTail
$ns duplex-link $attacker $server1 12mb 100-ms DropTail
$ns duplex-link $server1 $server2 6mb 200-ms DropTail 
